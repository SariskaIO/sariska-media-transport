...
const SphinxService = require('./transcriptionServices/SphinxTranscriptionService');
...
Transcriber.prototype.stop = function stop(callback) {
  ...
  this.audioRecorder.stop(); // and send all recorded audio to the transcription service
