...
export class PerformanceObserverStats {
  ...
  startObserver() {
    ...
    const startTime = Date.now(); // Calculate the average # of events/sec and emit a stats event.
    ...
    this.longTasksIntervalId = setInterval(() => {
      ...
      this.eventEmitter.emit(StatisticsEvents.LONG_TASKS_STATS, this.getLongTasksStats()); // Reset the counter and start counting events again.
