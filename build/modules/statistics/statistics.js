...
export default function Statistics(xmpp, options) {
  ...
  this.callStatsIntegrationEnabled = this.options.callStatsID && this.options.callStatsSecret && this.options.enableCallStats // Even though AppID and AppSecret may be specified, the integration
...
Statistics.sendGetUserMediaFailed = function (e) {
  const error = e instanceof JitsiTrackError ? formatJitsiTrackErrorForCallStats(e) : e;
