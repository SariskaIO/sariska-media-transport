...
export class FlacAdapter extends AbstractAudioContextAdapter {
  ...
  constructor() {
    ...
    _defineProperty(this, "_encoder", null);

    _defineProperty(this, "_stopPromiseResolver", null);

    _defineProperty(this, "_initWorkerPromiseResolver", null);
  ...
  _initialize(micDeviceId) {
    ...
    const promiseInitWorker = new Promise((resolve, reject) => {
      ...
      this._initWorkerPromiseResolver = resolve; // set up listener for messages from the WebWorker
