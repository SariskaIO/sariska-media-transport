...
import * as DetectionEvents from './DetectionEvents'; // We wait a certain time interval for constant silence input from the current device to account for
...
export default class NoAudioSignalDetection extends EventEmitter {
  ...
  _trackAdded(track) {
    if (track.isLocalAudioTrack()) {
      ...
      this._clearTriggerTimeout(); // Listen for the audio levels on the newly added audio track
