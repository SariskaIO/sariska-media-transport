...
const ScreenObtainer = {
  ...
  obtainScreenOnElectron(onSuccess, onFailure) {
    if (window.JitsiMeetScreenObtainer && window.JitsiMeetScreenObtainer.openDesktopPicker) {
      ...
      window.JitsiMeetScreenObtainer.openDesktopPicker({
        ...
        if (streamId) {
          var _desktopSharingFrameR, _desktopSharingFrameR2;
          ...
          const constraints = {
            ...
            video: {
              mandatory: {
                ...
                minFrameRate: (_desktopSharingFrameR = desktopSharingFrameRate === null || desktopSharingFrameRate === void 0 ? void 0 : desktopSharingFrameRate.min) !== null && _desktopSharingFrameR !== void 0 ? _desktopSharingFrameR : SS_DEFAULT_FRAME_RATE,
                maxFrameRate: (_desktopSharingFrameR2 = desktopSharingFrameRate === null || desktopSharingFrameRate === void 0 ? void 0 : desktopSharingFrameRate.max) !== null && _desktopSharingFrameR2 !== void 0 ? _desktopSharingFrameR2 : SS_DEFAULT_FRAME_RATE,
          ...
          navigator.mediaDevices.getUserMedia(constraints).then(stream => onSuccess({
            stream,
            sourceId: streamId,
  ...
  obtainScreenFromGetDisplayMedia(callback, errorCallback) {
    ...
    const video = typeof desktopSharingFrameRate === 'object' ? {
      frameRate: desktopSharingFrameRate
    } : true;

    const audio = this._getAudioConstraints(); // At the time of this writing 'min' constraint for fps is not supported by getDisplayMedia.
    ...
    logger.info('Using getDisplayMedia for screen sharing 1', constraints);
  ...
  obtainScreenFromGetDisplayMediaRN(callback, errorCallback) {
    logger.info('Using getDisplayMedia for screen sharing 2');
      console.log("HEre in herere");
