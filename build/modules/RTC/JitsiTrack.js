...
export default class JitsiTrack extends EventEmitter {
  ...
  setAudioLevel(audioLevel, tpc) {
    let newAudioLevel = audioLevel; // When using getSynchornizationSources on the audio receiver to gather audio levels for
    ...
    if (this.audioLevel !== newAudioLevel) {
      ...
      this.emit(JitsiTrackEvents.TRACK_AUDIO_LEVEL_CHANGED, newAudioLevel, tpc); // LocalStatsCollector reports a value of 0.008 for muted mics
