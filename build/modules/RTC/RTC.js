...
export default class RTC extends Listenable {
  ...
  constructor(conference, options = {}) {
    ...
    this._selectedEndpoints = null; // The last N change listener.
  ...
  static obtainAudioAndVideoPermissions(options) {
    return RTCUtils.obtainAudioAndVideoPermissions(options).then(tracksInfo => _createLocalTracks(tracksInfo));
  }
  /**
  ...
  initializeBridgeChannel(peerconnection, wsUrl) {
    ...
    this.addListener(RTCEvents.DATA_CHANNEL_OPEN, this._channelOpenListener); // Add Last N change listener.
  ...
  createPeerConnection(signaling, iceConfig, isP2P, options) {
    ...
    const supportsSdpSemantics = browser.isReactNative() || browser.isChromiumBased() && !options.usesUnifiedPlan;
