...
export default class ProxyConnectionService {
  ...
  processMessage(message) {
    ...
    if (action === ACTIONS.CONNECTION_ERROR || action === ACTIONS.UNAVAILABLE || action === ACTIONS.TERMINATE) {
  ...
  _onRemoteStream(jitsiRemoteTrack) {
    ...
    if (isVideo) {
      videoType = this._options.convertVideoToDesktop ? VideoType.DESKTOP : VideoType.CAMERA;
