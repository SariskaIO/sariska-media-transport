var createTFLiteSIMDModule = function () {
  ...
  return "undefined" != typeof __filename && (e = e || __filename), function (n) {
    ...
    p = "object" == typeof window, l = "function" == typeof importScripts, u = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node;
    var d,
        m,
        y = "";
    !p && !u && !l ? ("undefined" != typeof read && function (e) {
      return read(e);
    }, m = function (e) {
      var n, t;
    ...
    s = null, a.arguments && (i = a.arguments), a.thisProgram && (c = a.thisProgram), a.quit && (f = a.quit), a.wasmBinary && (g = a.wasmBinary), a.noExitRuntime && (h = a.noExitRuntime), "object" != typeof WebAssembly && k("no native wasm support detected");
    ...
    function S(e, n, t) {
      ...
      for (var o = ""; n < a;) {
        ...
        if (128 & s) {
          ...
          if (192 != (224 & s)) {
            var i = 63 & e[n++];
            if ((s = 224 == (240 & s) ? (15 & s) << 12 | u << 6 | i : (7 & s) << 18 | u << 12 | i << 6 | 63 & e[n++]) < 65536) o += String.fromCharCode(s);else {
              var c = s - 65536;
    ...
    var $,
      ...
      i: function (e, n) {
        k("To use dlopen, you need to use Emscripten's linking support, see https://github.com/emscripten-core/emscripten/wiki/Linking");
      },
      e: function (e, n) {
        k("To use dlopen, you need to use Emscripten's linking support, see https://github.com/emscripten-core/emscripten/wiki/Linking");
      },
      ...
      function o(n) {
        return function () {
          ...
          b("failed to asynchronously prepare wasm: " + e), k(e);
        });
      }
