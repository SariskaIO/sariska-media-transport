var createTFLiteSIMDModule = function () {
  ...
  return "undefined" != typeof __filename && (e = e || __filename), function (n) {
    ...
    !p && !s && !l ? ("undefined" != typeof read && function (e) {
      ...
      var n, t;
      return "function" == typeof readbuffer ? new Uint8Array(readbuffer(e)) : (n = read(e, "binary"), "object" == typeof n || F("Assertion failed: " + t), n);
    ...
    u = null, a.arguments && (i = a.arguments), a.thisProgram && (c = a.thisProgram), a.quit && (f = a.quit), a.wasmBinary && (g = a.wasmBinary), a.noExitRuntime && (h = a.noExitRuntime), "object" != typeof WebAssembly && F("no native wasm support detected");
    ...
    k(z) || (N = z, z = a.locateFile ? a.locateFile(N, y) : y + N), G = s ? function () {
    ...
    var ee,
      ...
      c: function (e, n, t, r) {
        for (var a = 0, o = 0; o < t; o++) {
          for (var u = E[n + 8 * o >> 2], s = E[n + (8 * o + 4) >> 2], i = 0; i < s; i++) $.printChar(e, M[u + i]);
      ...
      (g || "function" != typeof WebAssembly.instantiateStreaming || k(z) || B(z) || "function" != typeof fetch ? o(t) : fetch(z, {
        credentials: "same-origin"
      }).then(function (n) {
...
"object" == typeof exports && "object" == typeof module ? module.exports = createTFLiteSIMDModule : "function" == typeof define && define.amd ? define([], function () {
  return createTFLiteSIMDModule;
}) : "object" == typeof exports && (exports.createTFLiteSIMDModule = createTFLiteSIMDModule);