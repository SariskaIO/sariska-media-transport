...
export default class PingConnectionPlugin extends ConnectionPlugin {
  ...
  constructor({
    ...
    this.pingThreshold = typeof pingOptions.threshold === 'number' ? pingOptions.threshold : PING_DEFAULT_THRESHOLD; // The number of timestamps of send pings to keep.
  ...
  getPingSuspendTime() {
    ...
    maxInterval -= this.pingInterval; // make sure we do not return less than 0
