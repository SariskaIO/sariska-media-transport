    ...
    if (json.sources.hasOwnProperty(owner)) {
      ...
      if (videoSources === null || videoSources === void 0 ? void 0 : videoSources.length) {
        for (let i = 0; i < videoSources.length; i++) {
          ...
          ssrcs.push((_videoSources$i = videoSources[i]) === null || _videoSources$i === void 0 ? void 0 : _videoSources$i.s);
        }
      }
      ...
      if (audioSources === null || audioSources === void 0 ? void 0 : audioSources.length) {
        for (let i = 0; i < audioSources.length; i++) {
          ...
          ssrcs.push((_audioSources$i = audioSources[i]) === null || _audioSources$i === void 0 ? void 0 : _audioSources$i.s);
        }
      }
