...
describe('XmppConnection', () => {
  ...
  beforeEach(() => {
    ...
    sendIQSpy = spyOn(mockStropheConnection, 'sendIQ').and.callThrough(); // eslint-disable-next-line no-empty-function
  ...
  describe('sendIQ2', () => {
    it('will send the IQ immediately if connected', () => {
      ...
      return connection.sendIQ2(testIQ(), {
        timeout: 15000
      }).then(() => {
