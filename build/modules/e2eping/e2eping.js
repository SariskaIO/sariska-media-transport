...
class ParticipantWrapper {
  ...
  handleResponse(response) {
    ...
    if (request) {
      ...
      this.e2eping.eventEmitter.emit(E2ePingEvents.E2E_RTT_CHANGED, this.participant, request.rtt);
    }
  ...
  sendAnalytics(rtt) {
    Statistics.sendAnalytics(createE2eRttEvent(this.id, this.participant.getProperty('region'), rtt));
  }
...
export default class E2ePing {
  ...
  constructor(conference, options, sendMessage) {
    ...
    conference.on(JitsiConferenceEvents.USER_JOINED, this.participantJoined);
    ...
    conference.on(JitsiConferenceEvents.DATA_CHANNEL_OPENED, this.dataChannelOpened);
  }
  /**
  ...
  stop() {
    ...
    this.conference.off(JitsiConferenceEvents.DATA_CHANNEL_OPENED, this.dataChannelOpened);
