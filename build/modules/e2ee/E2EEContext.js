...
export default class E2EEcontext {
  ...
  handleReceiver(receiver, kind, participantId) {
    ...
    if (receiver.createEncodedStreams) {
      ...
      receiverStreams = kind === 'video' ? receiver.createEncodedVideoStreams() : receiver.createEncodedAudioStreams();
    }
    ...
    this._worker.postMessage({
      ...
      participantId
    }, [receiverStreams.readable || receiverStreams.readableStream, receiverStreams.writable || receiverStreams.writableStream]);
  }
  /**
  ...
  handleSender(sender, kind, participantId) {
    ...
    if (sender.createEncodedStreams) {
      ...
      senderStreams = kind === 'video' ? sender.createEncodedVideoStreams() : sender.createEncodedAudioStreams();
    }
    ...
    this._worker.postMessage({
      ...
      participantId
    }, [senderStreams.readable || senderStreams.readableStream, senderStreams.writable || senderStreams.writableStream]);
  }
  /**
