...
export class E2EEncryption {
  ...
  static isSupported(config) {
    ...
    return !(config.testing && config.testing.disableE2EE) && (browser.supportsInsertableStreams() || config.enableEncodedTransformSupport && browser.supportsEncodedTransform());
  }
  /**
