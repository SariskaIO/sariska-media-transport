...
export default class LocalSdpMunger {
  ...
  _addMutedLocalVideoTracksToSDP(transformer) {
    ...
    const videoMLine = (_transformer$selectMe = transformer.selectMedia(MediaType.VIDEO)) === null || _transformer$selectMe === void 0 ? void 0 : _transformer$selectMe[0];
    ...
    for (const videoTrack of localVideos) {
      ...
      const isCamera = videoTrack.videoType === VideoType.CAMERA; // During the mute/unmute operation there are periods of time when
  ...
  _generateMsidAttribute(mediaType, trackId, streamId = null) {
    ...
    const pcId = this.tpc.id; // Handle a case on Firefox when the browser doesn't produce a 'a:ssrc' line with the 'msid' attribute or has
  ...
  _transformMediaIdentifiers(mediaSection) {
    var _mediaSection$mLine, _mediaSection$mLine2;

    const mediaType = (_mediaSection$mLine = mediaSection.mLine) === null || _mediaSection$mLine === void 0 ? void 0 : _mediaSection$mLine.type;
        ...
        case 'msid':
          {
            if (ssrcLine.value) {
              ...
              const trackId = streamAndTrackIDs[1]; // eslint-disable-next-line max-depth

              if (FeatureFlags.isMultiStreamSupportEnabled() && this.tpc.usesUnifiedPlan() && mediaType === MediaType.VIDEO) {
  ...
  transformStreamIdentifiers(sessionDesc) {
    var _transformer$selectMe2, _transformer$selectMe3;
    ...
    const audioMLine = (_transformer$selectMe2 = transformer.selectMedia(MediaType.AUDIO)) === null || _transformer$selectMe2 === void 0 ? void 0 : _transformer$selectMe2[0];
    ...
    const videoMLine = (_transformer$selectMe3 = transformer.selectMedia(MediaType.VIDEO)) === null || _transformer$selectMe3 === void 0 ? void 0 : _transformer$selectMe3[0];
  ...
  _injectSourceNames(mediaSection) {
    var _mediaSection$mLine5, _mediaSection$mLine5$, _mediaSection$mLine6;

    if (!FeatureFlags.isSourceNameSignalingEnabled()) {
      return;
    }

    const sources = [...new Set((_mediaSection$mLine5 = mediaSection.mLine) === null || _mediaSection$mLine5 === void 0 ? void 0 : (_mediaSection$mLine5$ = _mediaSection$mLine5.ssrcs) === null || _mediaSection$mLine5$ === void 0 ? void 0 : _mediaSection$mLine5$.map(s => s.id))];
    const mediaType = (_mediaSection$mLine6 = mediaSection.mLine) === null || _mediaSection$mLine6 === void 0 ? void 0 : _mediaSection$mLine6.type;
