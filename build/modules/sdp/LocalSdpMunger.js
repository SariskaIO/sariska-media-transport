        ...
        case 'msid':
          {
            if (ssrcLine.value) {
              ...
              if (streamAndTrackIDs.length === 2) {
                var _mediaSection$mLine;

                ssrcLine.value = this._generateMsidAttribute((_mediaSection$mLine = mediaSection.mLine) === null || _mediaSection$mLine === void 0 ? void 0 : _mediaSection$mLine.type, streamAndTrackIDs[1], streamAndTrackIDs[0]);
              } else {
