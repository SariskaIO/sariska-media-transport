...
export default class SdpConsistency {
  ...
  makeVideoPrimarySsrcsConsistent(sdpStr) {
    var _sdpTransformer$selec;

    const sdpTransformer = new SdpTransformWrap(sdpStr);
    const videoMLine = (_sdpTransformer$selec = sdpTransformer.selectMedia(MediaType.VIDEO)) === null || _sdpTransformer$selec === void 0 ? void 0 : _sdpTransformer$selec[0];
      ...
      if (this.cachedPrimarySsrc) {
        ...
        for (const group of videoMLine.ssrcGroups) {
          if (group.semantics === 'FID') {
            ...
            const rtxSsrc = parseSecondarySSRC(group); // eslint-disable-next-line max-depth
