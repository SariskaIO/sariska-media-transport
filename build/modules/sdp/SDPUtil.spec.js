...
describe('SDPUtil', () => {
  ...
  describe('preferCodec for video codec', () => {
    it('should move a preferred video codec to the front', () => {
      ...
      const newPayloadTypesOrder = videoMLine.payloads.split(' ').map(ptStr => parseInt(ptStr, 10));
  ...
  describe('preferCodec for audio codec', () => {
    it('should move a preferred audio codec to the front', () => {
      ...
      const newPayloadTypesOrder = audioMLine.payloads.split(' ').map(ptStr => parseInt(ptStr, 10));
