...
const MIN_REQUIRED_IOS_VERSION = 14; // TODO: Move this code to js-utils.
...
export default class BrowserCapabilities extends BrowserDetection {
  ...
  isWebKitBased() {
    ...
    return this._bowser.isEngine('webkit') && typeof navigator.mediaDevices !== 'undefined' && typeof navigator.mediaDevices.getUserMedia !== 'undefined' && typeof window.RTCRtpTransceiver !== 'undefined' // eslint-disable-next-line no-undef
  ...
  supportsReceiverStats() {
    return typeof window.RTCRtpReceiver !== 'undefined' && Object.keys(RTCRtpReceiver.prototype).indexOf('getSynchronizationSources') > -1 // Disable this on Safari because it is reporting 0.000001 as the audio levels for all
    // remote audio tracks.
    && !this.isWebKitBased();
  }
  /**
