...
function _mergeNamespaceAndModule(module) {
  return typeof window.SariskaMediaTransport === 'object' ? Object.assign({}, window.SariskaMediaTransport, module) : module;
}
/**
...
export default _mergeNamespaceAndModule({
  ...
  init(options = {}) {
    ...
    FeatureFlags.init(options.flags || {}); // Initialize global window.connectionTimes
  ...
  */
  ...
  createLocalTracks(options = {}, oldfirePermissionPromptIsShownEvent) {
    ...
    return RTC.obtainAudioAndVideoPermissions(restOptions).then(tracks => {
      ...
      for (const track of tracks) {
        if (track.type === MediaType.VIDEO && track.videoType === 'desktop') {
