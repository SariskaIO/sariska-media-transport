...
export const ACTION_JINGLE_TR_RECEIVED = 'transport-replace.received';
/**
 * The "action" value for Jingle events which indicates that a transport-replace
...
export const ACTION_JINGLE_TR_SUCCESS = 'transport-replace.success';
/**
...
export const createConnectionFailedEvent = function (errorType, errorMessage, details) {
  return {
    type: TYPE_OPERATIONAL,
