...
function calculateLocalTrackDuration(state, conference) {
    ...
    const newDuration = Object.assign({}, localTracksDuration);
    ...
    return Object.assign(Object.assign({}, localTracksDuration), newDuration);
}
export default class LocalTracksDuration {
    constructor(conference) {
        conference.addEventListener(JitsiConferenceEvents.CONFERENCE_JOINED, () => {
            FINAL_STATE = {
                localTracksDuration: Object.assign(Object.assign({}, calculateLocalTrackDuration(INITIAL_STATE, conference)), { conference: {
        ...
        conference.addEventListener(JitsiConferenceEvents.TRACK_UPDATED, () => {
            ...
            FINAL_STATE = {
                localTracksDuration: Object.assign(Object.assign({}, localTracksDuration), calculateLocalTrackDuration(FINAL_STATE, conference))
            };
        });
        ...
        conference.addEventListener(JitsiConferenceEvents.CONFERENCE_LEFT, () => {
            const { localTracksDuration } = FINAL_STATE;
            const newLocalTracksDuration = Object.assign(Object.assign({}, calculateLocalTrackDuration(FINAL_STATE, conference)), { conference: {
                    startedTime: -1,
...
//# sourceMappingURL=LocalTracksDuration.js.map