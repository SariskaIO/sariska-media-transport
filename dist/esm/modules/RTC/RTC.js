...
export default class RTC extends Listenable {
    ...
    _onForwardedSourcesChanged(forwardedSources = []) {
        ...
        this.conference.eventEmitter.emit(JitsiConferenceEvents.FORWARDED_SOURCES_CHANGED, leavingForwardedSources, enteringForwardedSources, Date.now());
    }
    /**
    ...
    createPeerConnection(signaling, pcConfig, isP2P, options) {
        ...
        if (typeof options.abtestSuspendVideo !== 'undefined') {
            ...
            Statistics.analytics.addPermanentProperties({ abtestSuspendVideo: options.abtestSuspendVideo });
        }
