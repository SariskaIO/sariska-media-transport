    ...
    doInitialize(options) {
        ...
        if (this.isP2P) {
            ...
            pcOptions.disableSimulcast
                = options.disableSimulcast || ((_a = options.videoQuality) === null || _a === void 0 ? void 0 : _a.preferredCodec) === CodecMimeType.H264;
            ...
            pcOptions.capScreenshareBitrate = pcOptions.disableSimulcast
                || !(typeof ((_b = options.desktopSharingFrameRate) === null || _b === void 0 ? void 0 : _b.max) === 'number'
                    && ((_c = options.desktopSharingFrameRate) === null || _c === void 0 ? void 0 : _c.max) > SS_DEFAULT_FRAME_RATE);
        }
