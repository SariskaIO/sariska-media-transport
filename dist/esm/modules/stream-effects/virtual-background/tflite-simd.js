var createTFLiteSIMDModule = function () { var e = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0; return "undefined" != typeof __filename && (e = e || __filename), function (n) { var t, r, a = void 0 !== (n = n || {}) ? n : {}; a.ready = new Promise(function (e, n) { t = e, r = n; }); var o, s = {}; for (o in a)
    ...
    ++a; if (a - n > 16 && e.subarray && R)
    return R.decode(e.subarray(n, a)); for (var o = ""; n < a;) {
    var s = e[n++];
    if (128 & s) {
        var u = 63 & e[n++];
        if (192 != (224 & s)) {
            var i = 63 & e[n++];
            if ((s = 224 == (240 & s) ? (15 & s) << 12 | u << 6 | i : (7 & s) << 18 | u << 12 | i << 6 | 63 & e[n++]) < 65536)
    ...
    if ("function" != typeof n) {
        var t = n.func;
        "number" == typeof t ? void 0 === n.arg ? C.get(t)() : C.get(t)(n.arg) : t(void 0 === n.arg ? null : n.arg);
    }
    else
        n(a);
} } F(G) || (G = G), N = u ? function () { var e = process.hrtime(); return 1e3 * e[0] + e[1] / 1e6; } : "undefined" != typeof dateNow ? dateNow : function () { return performance.now(); }; var Y = !0; function J(e) { return E[te() >> 2] = e, e; } function K(e) { try {
    ...
    for (var n in e)
        t.push(n + "=" + e[n]);
    V.strings = t;
} return V.strings; } var Z = { mappings: {}, buffers: [null, [], []], printChar: function (e, n) { var t = Z.buffers[e]; 0 === n || 10 === n ? ((1 === e ? w : b)(S(t, 0)), t.length = 0) : t.push(n); }, varargs: void 0, get: function () { return Z.varargs += 4, E[Z.varargs - 4 >> 2]; }, getStr: function (e) { return function (e, n) { return e ? S(M, e, n) : ""; }(e); }, get64: function (e, n) { return e; } }; var $, ee = { a: function () { k(); }, n: function (e, n) { var t; if (0 === e)
        t = Date.now();
    else {
        if (1 !== e && 4 !== e || !Y)
            return J(28), -1;
        t = N();
    } return E[n >> 2] = t / 1e3 | 0, E[n + 4 >> 2] = t % 1e3 * 1e3 * 1e3 | 0, 0; }, i: function (e, n) { k("To use dlopen, you need to use Emscripten's linking support, see https://github.com/emscripten-core/emscripten/wiki/Linking"); }, e: function (e, n) { k("To use dlopen, you need to use Emscripten's linking support, see https://github.com/emscripten-core/emscripten/wiki/Linking"); }, l: function (e, n, t) { M.copyWithin(e, n, n + t); }, m: function (e) { e >>>= 0; var n = M.length; if (e > 2147483648)
        ...
        ; }, p: function (e, n) { var t = 0; return V().forEach(function (r, a) { var o = n + t; E[e + 4 * a >> 2] = o, function (e, n, t) { for (var r = 0; r < e.length; ++r)
        I[n++ >> 0] = e.charCodeAt(r); t || (I[n >> 0] = 0); }(r, o), t += r.length + 1; }), 0; }, g: function (e, n) { var t = V(); E[e >> 2] = t.length; var r = 0; return t.forEach(function (e) { r += e.length + 1; }), E[n >> 2] = r, 0; }, j: function (e) { !function (e, n) { n && h && 0 === e || (h || (e, !0, a.onExit && a.onExit(e), _ = !0), f(e, new re(e))); }(e); }, h: function (e) { return 0; }, k: function (e, n, t, r, a) { }, c: function (e, n, t, r) { for (var a = 0, o = 0; o < t; o++) {
        for (var s = E[n + 8 * o >> 2], u = E[n + (8 * o + 4) >> 2], i = 0; i < u; i++)
            Z.printChar(e, M[s + i]);
        a += u;
    } return E[r >> 2] = a, 0; }, d: function () { return 6; }, f: function () { return 28; }, b: function (e) { switch (e) {
    ...
    } return J(28), -1; } }, ne = (function () { var e = { a: ee }; function n(e, n) { var t = e.exports; a.asm = t, O((v = a.asm.q).buffer), C = a.asm.D, function (e) { if (W--, a.monitorRunDependencies && a.monitorRunDependencies(W), 0 == W && (null !== D && (clearInterval(D), D = null), L)) {
    var n = L;
    L = null, n();
...
} return Promise.resolve().then(function () { return z(G); }); }().then(function (n) { return WebAssembly.instantiate(n, e); }).then(n, function (e) { b("failed to asynchronously prepare wasm: " + e), k(e); }); } if (W++, a.monitorRunDependencies && a.monitorRunDependencies(W), a.instantiateWasm)
    try {
    ...
    for ("function" == typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length;)
        e = a.preRun.shift(), T.unshift(e); var e; X(T); }(), W > 0 || (a.setStatus ? (a.setStatus("Running..."), setTimeout(function () { setTimeout(function () { a.setStatus(""); }, 1), n(); }, 1)) : n())); } if (L = function e() { $ || ae(), $ || (L = e); }, a.run = ae, a.preInit)
