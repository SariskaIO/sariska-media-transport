...
export default class JitsiStreamPresenterEffect {
    ...
    constructor(videoStream) {
        ...
        const { height, width, frameRate } = (_a = firstVideoTrack.getSettings()) !== null && _a !== void 0 ? _a : firstVideoTrack.getConstraints();
    ...
    _renderVideo() {
        ...
        const { height, width } = (_a = track.getSettings()) !== null && _a !== void 0 ? _a : track.getConstraints();
    ...
    startEffect(desktopStream) {
        ...
        const { height, width } = (_a = firstVideoTrack.getSettings()) !== null && _a !== void 0 ? _a : firstVideoTrack.getConstraints();
