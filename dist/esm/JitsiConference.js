...
JitsiConference.prototype.getParticipantsWithoutHidden = function () {
    ...
    participants = participants.filter(participant => { var _a; return !((_a = participant === null || participant === void 0 ? void 0 : participant._properties) === null || _a === void 0 ? void 0 : _a.features_jigasi); });
    return participants;
};
/**
...
JitsiConference.prototype.handleSubtitles = function () {
    ...
    this.on(JitsiConferenceEvents.ENDPOINT_MESSAGE_RECEIVED, (participant, json) => {
        ...
        try {
            ...
            const fellowParticipantName = ((_d = (_c = (_b = this.participants[(_a = json === null || json === void 0 ? void 0 : json.participant) === null || _a === void 0 ? void 0 : _a.id]) === null || _b === void 0 ? void 0 : _b._identity) === null || _c === void 0 ? void 0 : _c.user) === null || _d === void 0 ? void 0 : _d.name) || ((_e = this === null || this === void 0 ? void 0 : this.getLocalUser()) === null || _e === void 0 ? void 0 : _e.name);
            this.eventEmitter.emit(JitsiConferenceEvents.SUBTITLES_RECEIVED, (_f = json === null || json === void 0 ? void 0 : json.participant) === null || _f === void 0 ? void 0 : _f.id, fellowParticipantName, finalText);
        }
        catch (error) {
...
JitsiConference.prototype.sendRTCStatsEventForConference = function () {
    this.on(JitsiConferenceEvents.TRACK_ADDED, (data) => {
        var _a;
        const jitsiTrack = (_a = data === null || data === void 0 ? void 0 : data.track) === null || _a === void 0 ? void 0 : _a.jitsiTrack;
    ...
    this.on(JitsiConferenceEvents.TRACK_UPDATED, (data) => {
        const { videoType, jitsiTrack, muted } = (data === null || data === void 0 ? void 0 : data.track) || {};
