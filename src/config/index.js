...
export const connectionDefaultOptions = {
    hosts: {
        domain: 'sariska.io',
        muc: 'muc.sariska.io'
    },
...
export const conferenceDefaultOptions = {
    ...
    enableTalkWhileMuted: true,  // - boolean property. Enables/disables talk while muted detection, by default the value is false/disabled.
